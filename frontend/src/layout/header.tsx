      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5  mb-10" >
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="/" className="flex items-center">
            <img
              src={Icon}
              className="mr-3 h-4 sm:h-8 bg-white"
              alt="Logo"
            />
          </a>
          <div className="flex items-center lg:order-2">
            ...
            <a
              href="/admin"
              className=" text-black bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-bold rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
            >
              <FaUser className="inline mr-4" /> Login as Admin
            </a>
            <button
